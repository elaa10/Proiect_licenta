...
from app.services import visual_matcher_px as matcher
...
async def diagnose(url: str) -> None:
    ...
    print("\n[2/4] Loading embeddings knowledge base (PX)...")
    ...
    print("\n[3/4] Computing query embeddings (pixel multi-crop)...")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scripts/diagnose_visual_px.py <URL> [<URL2> ...]")
        sys.exit(1)
