...
from app.services.visual_matcher_px2 import match_brand_px, _load
...
def evaluate():
    ...
    if not _load():
        print("ERROR: brand_embeddings_px2.pkl not found. "
              "Run scripts/init_brand_db_px2.py first.")
        sys.exit(1)
    ...
    out = RESULTS_DIR / "visual_evaluation_px2.json"
    ...
    print(f"  visual_evaluation_px2.json        — pixel crops, no filter       (this run)")
