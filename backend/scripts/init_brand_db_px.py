"""
Build brand_embeddings_px.pkl using original pixel-based multi-crop strategy.

Goes in: backend/scripts/init_brand_db_px.py
...
Output: /app/data/brand_embeddings_px.pkl
"""
import asyncio
import pickle
...
async def main():
    ...
    if EMBEDDINGS_PATH.exists():
        ...
        print(f"Resuming: {len(embeddings)} brands already in px pkl\n")
